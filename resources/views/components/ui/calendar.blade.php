...
@can('read event')
    <div class="mb-3">
            ...
            <div class="col-md-3">
                <div class="h-100">
                    ...
                    <div class="border-start border-top border-2 border-primary h-100 p-2 my-2 bg-light">
                        <div class="d-flex flex-column gap-1 currentEvents " style="max-height: 70dvh;overflow-y:scroll;">
        ...
        <input type="hidden" name="servicesData" value="{{ json_encode($services) }}">
