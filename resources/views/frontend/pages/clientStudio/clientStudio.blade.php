                ...
                <div class="bg-primary rounded-3 overflow-hidden">
                    <div class="d-flex bg-white justify-content-around align-items-center p-3">
                        ...
                        <div class="d-flex flex-column justify-content-center align-items-center">
                            <h2 class="counter-up m-0" style="font-size: 36px; color: #1abcfe; font-weight: 700;">{{ $datum->count }}</h2>
                        </div>
                    </div>
                    <div class="mt-auto px-2 py-2 w-100"
                        style='
                                    ...
                                    '>
                        <p class="text-center text-light m-0" style="font-size: 16px;">{{ strlen($datum->title) > 20 ? substr($datum->title, 0, 20) . '...' : $datum->title }}</p>
                    </div>
                </div>
            </div>  
            @endforeach
