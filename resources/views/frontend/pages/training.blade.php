        ...
        <div id="carouselExampleFade" class="border-bottom carousel slide carousel-fade" data-bs-ride="carousel"> 
          ...
          <div class="row ">
            <div class="col-md-6 shadow-lg mt-4 mb-4">
              ...
              <p class="text-center px-5">Lorem ipsum dolor sit amet consectetur adipisicing elit. Tenetur voluptas nam voluptatum, molestias impedit dolore! Dolor quis, cumque exercitationem dicta iusto atque dolorum eaque repudiandae odio! Ut reprehenderit temporibus voluptate aliquam? Cum, soluta reiciendis velit blanditiis ea molestiae rem odit. Est ipsam molestiae delectus minima, dicta praesentium modi quos? Atque deleniti, dolorum numquam reiciendis corrupti tenetur quibusdam officiis dignissimos corporis.</p>
          ...
          <div class="card">
            <div class="card-body">
              ...
              <p class="mt-3 d-flex justify-content-center text-center">
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Quo assumenda nobis voluptate ex eum omnis necessitatibus eaque exercitationem harum, totam at sequi magni maxime tempore expedita nisi voluptatum laborum asperiores.
              </p>
              <div class="row">
          ...
          <div class="bg-light mt-3 mb-4 ">
            ...
            <p class="text-center mt-3 py-5 pt-4 px-5">Lorem ipsum dolor sit amet consectetur adipisicing elit. Nisi, commodi accusantium! Reprehenderit, nulla at debitis voluptatibus id necessitatibus tenetur vero magnam, impedit iusto consectetur fugiat fugit excepturi obcaecati rerum laboriosam optio ipsa commodi ab itaque ad odio sapiente maiores blanditiis. Perferendis, mollitia reiciendis.</p>
          </div>
          <div class="continer">
            <div class="row">
