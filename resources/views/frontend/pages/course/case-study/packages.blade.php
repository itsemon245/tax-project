...
@section('main')
        ...
        <div class="row">
            ...
            <div class="col-md-4 ">
                <div class=" card overflow-hidden">
                    <img loading="lazy" class="shadow-lg" src="{{ useImage($packages[0]->page_image) }}" alt=""
    ...
    <div class="mt-3 d-flex flex-wrap gap-3 justify-content-center mt-3 mb-5">
        <div class="row">
            @foreach ($packages as $package)
                <div class="col-md-4">
                    <div class="px-2 py-2 mb-3 card h-100">
                        <div class="card-body">
                            <h3>{{ $package->name }}</h3>
