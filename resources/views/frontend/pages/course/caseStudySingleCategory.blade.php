            ...
            <div class="row mb-24">
                ...
                <div class="col-md-8">
                    <div class="w-100 h-100 p-3">
                        <div class="">
                            <h5 class="text-capitalize fs-3 mb-0">Lorem ipsum dolor sit.</h5>
                            <span class="">by </span> <i style="font-weight: 500;">Lorem, ipsum.</i>
                            <p class="mb-3 fw-bold fs-5">
                                Price:
                                <span class="text-dark" style="font-weight: 500;">54</span>
                                <span class="mdi mdi-currency-bdt text-dark"></span>
                            </p>
                            <p class="mw-2xl mb-5">
                                Lorem ipsum dolor, sit amet consectetur adipisicing elit. Cum omnis quia, corporis itaque sequi distinctio voluptatibus maxime animi explicabo quam exercitationem? Labore, laudantium.
                            </p>
                        </div>
