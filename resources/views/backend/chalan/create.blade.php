                ...
                <div class="col-lg-12 table-responsive">
                    <table class="w-100 chala_table">
                        <tbody>
                            ...
                            <tr>
                                <td colspan="8" class="col-lg-8 chalan_table_row text-start"> <span
                                        class="d-inline-block"> টাকা কথায়</span> <input type="text"
                                        class="d-inline-block w-75 dotted-border"> <span class="text-end ms-5 w-25"> মোট
                                        টাকা </span> </td>
                                <td colspan="1" class="col-lg-1 chalan_table_row">
                                    <input type="text" class="form-control" placeholder="Ammount">
                                </td>
                            ...
                            <tr>
                                <td colspan="8" class="col-lg-8 chalan_table_row text-start"> <span
                                        class="d-inline-block"> টাকা পাওয়া গেল </span> <input type="text"
                                        class="d-inline-block w-75 dotted-border"> </td>
                            </tr>
                            <tr>
                                <td colspan="8" class="col-lg-8 chalan_table_row1 text-start"> <span
                                        class="d-inline-block">তারিখ</span> <input type="date"
                    ...
                    <div class=" d-flex flex-column text-start">
                        ...
                        <span>নোটঃ ২। * যেঁ সকল ক্ষেত্রে কর্মকর্তা কতৃক পৃষ্টাংকন প্রয়োজন, সে সকল ক্ষেত্রে প্রযোজ্য
                            হইবে।</span>
