    ...
    <x-backend.ui.section-card name="Create Invoice">
        <div class="" style="">
            ...
            <div class="card-body">
                    ...
                    <div class="float-start">
                        <div class="auth-logo">
                            <div class="logo logo-dark">
                                <span class="logo-lg">
                                    <img src="{{ asset('backend/assets/images/logo-dark-2.png') }}" alt=""
                                        height="22">
                                </span>
                            </div>
                ...
                <div class="row">
                    <div class="col-md-5">
                        <div class="mt-3">
                            <h4>Bill To</h4>
                            <p class="text-muted">
                            <p class="mb-0"><b>Mohammad Emdad</b></p>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <x-backend.form.text-input type="text" name="text_input" label="Text Input" class="other classes"
                            required />
                    </div> <!-- end col -->
                    <div class="col-sm-6">
                        <div class="float-end">
