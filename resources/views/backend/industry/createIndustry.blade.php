               ...
               <div class="row">
                    <div class="col-md-6">
                        <div class="mt-1">
                           ...
                           <input type='text' name="titles[]" placeholder="Section Title" class="form-control" />
                        </div>
                        <div class="mt-1">
                            <label for="section-editor-${itemCount}" class="form-label">Section Description ${itemCount}</label>
                            <textarea id="section-editor-${itemCount}" name="descriptions[]" placeholder="Section Description">
                    ...
                    <div class="col-md-6">  
                        <label for="section-image-${itemCount}">
                                ...
                                <input id="section-image-${itemCount}" class="custom-input" data-index="${itemCount}" type="file" name="images[]" hidden>
