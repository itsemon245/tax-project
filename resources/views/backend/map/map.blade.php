        ...
        <form action="{{ route('map.store') }}" method="post">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        <div>
                            <x-form.selectize class="mb-1" id="district" name="district" placeholder="Select District..."
                                label="District" :canCreate="false">
                                @foreach ($districts as $district)
                                    <option value="{{ $district->district }}" @selected($district->district === 'Chattogram')>
                    ...
                    <div class="col-md-6">
                        @php
                            $defaultThanas = $districts->filter(fn($d) => $d->district === 'Chattogram')->first()?->upazilla;
                        @endphp
                    ...
                    <div class="col-md-6">
                        ...
                        <x-form.text-area id="iframe-link" name="iframe_link" label="Iframe Link"
                            placeholder="<iframe ....></iframe>" rows="4" required></x-form.text-area>

                    </div>
                    <div class="col-md-6">
                        <div class="custom-editor">

                            <x-form.ck-editor label="Address" id="address" name="address" placeholder="Address"
                                required></x-form.ck-editor>
                        </div>

                    </div>
                    <div class="col-12">
                        <x-backend.ui.button class="btn-primary btn-sm float-end">Create</x-backend.ui.button>
                    </div>
                </div>
            </div>
        </form>
