        ...
        <div class="row">
            @forelse ($maps as $map)
                <div class="col-md-4">
                    <div class="card">
                        <iframe src="{{ $map->src }}"
                            class="w-100 rounded-top rounded-left rounded-right shadow-top shadow-start shadow-end"
                        ...
                        <div class="card-body p-2">
                            ...
                            @endcan
                            @can('delete map')
                                <x-backend.ui.button class="btn-sm" type='delete'
                                    action="{{ route('map.destroy', $map) }}"></x-backend.ui.button>
                            @endcan
                        </div>
                    </div> <!-- end card-->
                </div> <!-- end col -->
