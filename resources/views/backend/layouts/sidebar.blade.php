    ...
    <div class="h-100" data-simplebar>
        ...
        <div id="sidebar-menu">
            ...
            <ul id="side-menu">
                ...
                @endcanany
                @canany(['manage partner', 'read partner', 'manage partner request', 'read partner request', 'manage client studio', 'read client studio', 'create expert', 'update expert', 'delete expert', 'read expert'])
                <li>
                    ...
                    <div class="collapse" id="peoples">
                        <ul class="nav-second-level">
                            @canany(['manage partner', 'manage partner request', 'read partner', 'read partner request'])
                            <li>
                ...
                @canany(['manage discussion', 'read discussion', 'create progress', 'update progress', 'delete progress', 'update task progress', 'read task progress'])
                <li>
                ...
                <li>
                    ...
                    <div class="collapse" id="user">
                        <ul class="nav-second-level">
                            @canany(['update appointment', 'delete appointment', 'approve appointment', 'read appointment'])
                            <li>
                ...
                $managementPermissions = \Spatie\Permission\Models\Permission::where('group', 'management')
                    ...
                    ->pluck('name');
                @endphp
                @canany($managementPermissions, 'create expense', 'update expense', 'delete expense', 'print expense', 'read expense', 'read role', 'read promo code', 'read reviews', 'read order')
                ...
                <li>
                    ...
                    <div class="collapse" id="taxCalculator">
                        <ul class="nav-second-level">
                           ...
                           @endcan
                           @canany(['create tax setting', 'update tax setting', 'delete tax setting', 'read tax setting'])
                           <li>
