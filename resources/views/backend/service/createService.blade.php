                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <x-form.ck-editor id="ck-editor2" name="price_description" placeholder="Price Description" label="Price Description">
                                </x-form.ck-editor>
                            </div>
                            <div class="col-md-12">
               ...
               <div class="row">
                    <div class="col-md-6">
                        <div class="mt-1">
                           ...
                           <input type='text' name="sections_title" placeholder="Section Title" class="form-control" />
                        </div>
                        <div class="mt-1">
                            <label for="section-editor-${itemCount}" class="form-label">Section Description ${itemCount}</label>
                            <textarea id="section-editor-${itemCount}" name="sections_image[]" placeholder="Section Description">
                    ...
                    <div class="col-md-6">  
                        <label for="section-image-${itemCount}">
                                ...
                                <input id="section-image-${itemCount}" type="file" name="sections_image[]" hidden>
