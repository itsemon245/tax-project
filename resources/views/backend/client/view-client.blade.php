...
@section('content')
    ...
    <x-backend.ui.section-card name="Client Section">
        <div class="mb-2">
            ...
            <x-backend.ui.button class="btn-sm fw-bold btn-info ms-1" data-bs-toggle="modal"
                data-bs-target="#modal-for-csv">Import
                CSV</x-backend.ui.button>
            <x-backend.ui.button type="custom" href="{{ route('client.execl.demo') }}"
                class="btn-sm fw-bold btn-success ms-1">Demo CSV</x-backend.ui.button>
        </div>
