...
@section('content')
    <x-backend.ui.breadcrumbs :list="['Dashboard', 'Product', 'Create']" />
            ...
            <div class="container rounded bg-white py-3 px-4">
                <div class="row">
                    <div class="col-md-12">
                        <div class="row">
                            <div class="col-md-6">
                                <x-backend.form.text-input label="Title" required type="text" name="title" required>
                            ...
                            <div class="col-md-6">
                                <x-backend.form.select-input id="sub-category" label="Product Sub Category"
                                    placeholder="Choose Category First" name="sub_category" required>
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-2">
                                                    ...
                                                    <select class="form-select" id="color" name="color[]">
                                                        <option value="#282e38" style="color:#282e38;" selected>Black
                                                        </option>
                                                        <option value="#1abc9c" style="color:#1abc9c;">Green
                                                        </option>
                                                        <option value="#f1556c" style="color:#f1556c;">Red
                                                        </option>
                                                    </select>
                                                </div>
                                            </div>
