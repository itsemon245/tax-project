        ...
        <div class="card p-3">
            <div class="row">
                <div class="col-md-12 mb-2">
                    <x-backend.form.text-input label="Name" type="text" name="name" value="{{$caseStudy->name ?? ''}}">
                ...
                <div class="col-md-12 mb-2">
                    <x-form.ck-editor id="ck-editor2" name="intro" placeholder="Intro"
                        label="intro">{{$caseStudy->intro}}</x-form.ck-editor>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <x-backend.form.select-input id="type" label="Case Study Package" name="case_study_category_id"
                                ...
                                <option value="{{$category->id}}" {{$category->id != $caseStudy->case_study_category_id ? '' : 'Selected'}}>{{$category->case_study_category}}</option>
                                @empty
                        ...
                        <div class="col-md-12">
                            <x-backend.form.select-input id="type" label="Package" name="case_study_package_id"
                                ...
                                <option value="{{$package->id}}" {{$package->id != $caseStudy->case_study_package_id ? '' : 'Selected'}}>{{$package->name}}</option>
                                @empty
                        ...
                        <div class="col-md-12">
                            <x-backend.form.text-input label="price"
                                placeholder="price" type="number" name="price" value="{{$caseStudy->price ?? '' }}"/>
                        </div>
