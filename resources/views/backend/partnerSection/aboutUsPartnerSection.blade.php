    ...
    <form action="{{ route('partner-section.store') }}" method="post" enctype="multipart/form-data">
        ...
        <div class="row">
            <div class="col-md-6">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <x-backend.form.text-input label="Designation" class="mb-2" type="text"  name="designation" required />  
                        </div>
                        <div class="col-md-6">
                            <x-backend.form.text-input label="Email" class="mb-2" type="email" name="email" required />  
                        </div>
                    </div> 
                    <div class="row">
                        <div class="col-md-6">
                            <x-backend.form.text-input label="Phone" class="mb-2" type="text"  name="phone" required />  
                        </div>
                        <div class="col-md-6">
                            <x-backend.form.text-input label="Facebook" class="mb-2" type="text" name="facebook" required />  
                        </div>
                    </div> 
                    <div class="row">
                        <div class="col-md-6">
                            <x-backend.form.text-input label="Twitter" class="mb-2" type="text"  name="twitter" required />  
                        </div>
                        <div class="col-md-6">
                            <x-backend.form.text-input label="Linkedin" class="mb-2" type="text" name="linkedin" required />  
                        </div>
                    </div> 
