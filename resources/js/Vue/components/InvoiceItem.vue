    ...
    <tr>
        ...
        <td>
            ...
            <div class="tax-wrapper">
                <a @click="toggleTaxPicker" id="tax-picker-0" data-toggle="#tax-picker-container-0"
                    class="text-blue p-1 d-inline-block" tabindex="0" role="button">
                ...
                <div ref="taxPicker" id="tax-picker-container-0" class="tax-container" :class="{ 'd-none': !isTaxActive }">
                    <div @click="toggleTaxPicker" class="close-icon btn border-0 rounded-circle waves-effect waves-light p-0">
                    ...
                    <div class="px-2">
                        <div v-for="tax in item.taxes" :key="tax.id" class="d-flex align-items-center gap-1 mb-2">
                            <div class="w-50">
                                ...
                                <div class="d-flex">
                                    <input type="text" :name="'tax-' + item.id + '-rates[]'"
                            ...
                            <div class="">
                                ...
                                <input type="text" :name="'tax-' + item.id + '-names[]'"
                                    class="w-100 border border-1 text-center p-1" placeholder="Tax Name" :value="tax.name"
                                    aria-label="Tax Name">
                            </div>
                            <div class="w-50">
                                <label class="form-label mb-0">Number</label>
                                <input type="text" :name="'tax-' + item.id + '-numbers[]'"
                                    class="w-100 border border-1 text-center p-1" placeholder="Number" :value="tax.number"
                                    aria-label="Tax Number">
                            </div>
                            <div class="align-self-end">
                                <span @click="$emit('deleteTaxItem', item.id, tax.id)"
                                    class="mdi mdi-trash-can-outline text-danger"></span>
                            </div>
                        </div>

                        <div class='d-flex justify-content-center align-items-center gap-2 my-3'>
                            <button @click="toggleTaxPicker" type="button" class="btn btn-soft-info py-1">Close</button>
                            <button @click="$emit('addTaxItem', item.id)" type='button' class='btn btn-success py-1'>Add
                                New</button>
                        </div>
                    </div>
                </div>
        ...
        <td>
            <div class="d-flex align-items-start">
                ...
                <span @click="$emit('deleteItem', item.id)" data-index="0"
